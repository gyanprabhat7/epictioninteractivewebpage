...
document.addEventListener("DOMContentLoaded", function() {
    ...
    $(function($) {
        ...
        $(".game-carousel").not('.slick-initialized').slick({
            ...
            slidesToScroll: 1,
            arrows: true,
            prevArrow: "<button type='button' aria-label='Slide Prev' class='arafat-prev box-style pull-left'><i class=\"material-symbols-outlined mat-icon\"  aria-hidden='true'>→</i> <span class='bg-obj'></span> </button>",
            nextArrow: "<button type='button' aria-label='Slide Next' class='arafat-next box-style pull-right'><i class=\"material-symbols-outlined mat-icon\"  aria-hidden='true'>→</i> <span class='bg-obj'></span> </button>",
            dots: false,
        ...
        $(".services-carousel").not('.slick-initialized').slick({
            ...
            slidesToScroll: 1,
            arrows: true,
            prevArrow: "<button type='button' aria-label='Slide Prev' class='arafat-prev box-style top-right pull-left'><i class=\"material-symbols-outlined mat-icon\"  aria-hidden='true'>→</i> <span class='bg-obj'></span> </button>",
            nextArrow: "<button type='button' aria-label='Slide Next' class='arafat-next box-style top-right pull-right'><i class=\"material-symbols-outlined mat-icon\"  aria-hidden='true'>→</i> <span class='bg-obj'></span> </button>",
            dots: false,
            dotsClass: 'section-dots',
            customPaging: function(slider, i) {
                var slideNumber = (i + 1),
